    ...
    <div class="container">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href=<%=application.getContextPath()%>/user/account.jsp><img id="head" style="width:50px;height:50px" src=<%=application.getContextPath()%>/<%=user.getImgFilePath()%>> 我的账户</a></li>
                            ...
                            <%
                                ...
                                {
                            %>
                            <li><a href=<%=application.getContextPath()%>/saler_account.jsp><img id="salerhead" style="width:50px;height:50px" src=<%=application.getContextPath()%>/<%=user.getImgFilePath()%> ></img> 我的账户</a></li><!--tip登陆后为账户叶面-->
                ...
                <div class="col-md-4">
                    <span id="discount">NB网今日购物折扣:<%=(double)application.getAttribute(Constant.GLOBAL_DISCOUNT)*10%>折!!!</span>
                </div>
            </div>
        </div>
    </div> <!-- End header area -->
